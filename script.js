...
(() => {
  ...
  const QUESTIONS = [
    {
      ...
      opts: [
        "Dasturlash tili",
        "Saytning skeleti (tuzilishi)",
        "Rasm tahrirlovchi dastur",
        "Kalkulyator dasturi",
      ],
      a: 1,
    },
    ...
    {
      q: "2. HTML'da eng katta sarlavha qaysi teg bilan yoziladi?",
      opts: ["&lt;h6&gt;", "&lt;h3&gt;", "&lt;h1&gt;", "&lt;title&gt;"],
      a: 2,
    },

    {
      q: "3. CSS nima?",
      opts: [
        "Saytning dizayni va ko'rinishi",
        "Hisoblashlar uchun dastur",
        "E-mail yuboruvchi dastur",
        "Matn muharriri",
      ],
      a: 0,
    },
    ...
    {
      q: "4. CSS'da matn rangi qaysi xususiyat bilan o'zgartiriladi?",
      opts: ["font-color", "text-color", "color", "text-red"],
      a: 2,
    },

    {
      q: "5. Paragrafni HTML'da qaysi teg bilan yozamiz?",
      opts: ["&lt;paragraf&gt;", "&lt;p&gt;", "&lt;text&gt;", "&lt;para&gt;"],
      a: 1,
    },

    {
      q: "6. HTML'da sahifaga rasm qo'yish uchun qaysi teg ishlatiladi?",
      opts: [
        "&lt;image&gt;",
        "&lt;img&gt;",
        "&lt;picture&gt;",
    ...
    {
      q: "7. CSS'da fon rangi qaysi xususiyat bilan o'zgartiriladi?",
      opts: ["background-color", "bg-color", "color-background", "back-color"],
      a: 0,
    },

    {
      q: "8. Matnni qalin qilish uchun qaysi teg ishlatiladi?",
      opts: ["&lt;thin&gt;", "&lt;i&gt;", "&lt;b&gt;", "&lt;u&gt;"],
      a: 2,
    },

    {
      q: "9. HTML'da link yaratish uchun qaysi teg ishlatiladi?",
      opts: ["&lt;url&gt;", "&lt;link&gt;", "&lt;a&gt;", "&lt;href&gt;"],
      a: 2,
    },

    {
      q: "10. Matnni markazga tekislash uchun CSS'da qanday qiymat ishlatiladi?",
      opts: [
        "text-align: middle",
        "text-align: center",
        "text-align: left",
    ...
    {
      q: "11. HTML'da tugma yaratish uchun qaysi teg ishlatiladi?",
      opts: ["&lt;click&gt;", "&lt;btn&gt;", "&lt;button&gt;", "&lt;key&gt;"],
      a: 2,
    },

    {
      q: "12. CSS'da matn o'lchamini kattalashtirish uchun qaysi xususiyat ishlatiladi?",
      opts: ["font-weight", "font-style", "font-size", "text-size"],
      a: 2,
    },

    {
      q: "13. HTML'da yangi qatorga o'tish uchun qaysi teg ishlatiladi?",
      opts: ["&lt;new&gt;", "&lt;break&gt;", "&lt;br&gt;", "&lt;line&gt;"],
      a: 2,
    },

    {
      q: "14. CSS'da matnni kursiv qilish uchun qaysi qiymat ishlatiladi?",
      opts: [
        "font-style: strong",
        "font-style: italic",
        "font-style: bold",
    ...
    {
      q: "15. HTML'da sahifaning asosiy qismi qaysi tegda yoziladi?",
      opts: ["&lt;main&gt;", "&lt;body&gt;", "&lt;html&gt;", "&lt;content&gt;"],
      a: 1,
    },

    {
      q: "16. CSS'da rasm atrofiga ramka chizish uchun qaysi xususiyat ishlatiladi?",
      opts: ["outline", "border", "line", "frame"],
      a: 1,
    },

    {
      q: "17. HTML'da tartibsiz ro'yxat uchun qaysi teg ishlatiladi?",
      opts: ["&lt;ol&gt;", "&lt;ul&gt;", "&lt;li&gt;", "&lt;list&gt;"],
      a: 1,
    },

    {
      q: "18. CSS'da rasm burchaklarini yumaloqlashtirish uchun qaysi xususiyat ishlatiladi?",
      opts: ["corner-round", "border-corners", "border-radius", "curve"],
      a: 2,
    },

    {
      q: "19. HTML'da matn ostiga chiziq chizish uchun qaysi teg ishlatiladi?",
      opts: [
        "&lt;underline&gt;",
        "&lt;u&gt;",
        "&lt;down-line&gt;",
    ...
    {
      q: "20. CSS'da linkning tagi chizilgan qismini olib tashlash uchun qaysi qiymat ishlatiladi?",
      opts: [
  ...
  function clearWinHighlights() {
    boardEl
      ...
      .forEach((el) => el.classList.remove("win", "x", "o"));
  }
  ...
  function aiMove() {
    ...
    if (best && best.move) {
      ...
      msgEl.textContent =
        "Sizning navbatingiz — katakka bosing va savolga javob bering.";
    } else {
      // fallback random
      const empties = [];
      for (let r = 0; r < SIZE; r++)
